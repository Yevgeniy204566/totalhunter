...
> Последнее обновление: 2026-05-01 (Хангоф #23 — Combo: 100% провал, диагностика завершена)
...
|---|---|---|---|
| **Combo** | combiner.py | 🔴 Реализован, 20 тестов ✅. Клики по 1й странице ТОЧНЫЕ. Скролл сломан: 1 unit≈1px, нужно scroll(-352) или Page Down. OCR [0,3] пропускает count=4. Маяк ненадёжен при val=1 | 2026-05-01 |
