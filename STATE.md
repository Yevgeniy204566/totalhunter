...
> Последнее обновление: 2026-06-16 **v1.7.3** — Хангоф #96. clan_roster_reader.py СБРОШЕН: HSV-архитектура провалилась (пустыня=пергамент), советы Gemini по pitch=172/NAME_X_FRAC=0.23 провалились. Фаза 0 — НАЧАТЬ С НУЛЯ в следующей сессии. Сохранить: clan_panel_screen=[688,346,724,363], tabs в profile_client.json.
