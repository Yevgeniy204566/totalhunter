...
> Последнее обновление: 2026-04-30 (Хангоф #22 — Модуль Combo реализован, калибровка в процессе)
...
|---|---|---|---|
| **Combo** | combiner.py | 🟡 Реализован, 20 тестов ✅, вкладка в GUI. Калибровка: GRID_X=589 — бот кликает ~200px мимо. Нужна доработка X | 2026-04-30 |
