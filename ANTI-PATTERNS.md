...
> Последнее обновление: 2026-06-15 (tournament_reader.py — absdiff `.mean()` vs `.max()`)
...
**Применимо к:** `tournament_reader.py::is_end_of_list` (Фаза 2, готово), будущий `ScrollableListScanner` (Фаза 0).
