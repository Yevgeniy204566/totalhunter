export const GUIDE = {
  ...
  chests: {
    ...
    webSteps: [
      ...
      { title: 'Language and preset', desc: 'Set the clan game language and press "Load Preset" — official chest names and points are filled in. The preset changes points only and keeps the "Accounting" of chests you already set. Remember to press "Save".' },
      ...
      { title: 'Season quotas', desc: 'Up to 3 quotas at once, e.g. "Epic Crypts" and "EM". Each has a name and a target: how many chests of that kind a player must collect per season.' },
      ...
      { title: 'Public page', desc: 'The clan gets its own link like total-hunter.com/c/229/eldorado. Members open it from a phone without registering: sort by any column, Russian/English. With "Enter troops" players fill in their rank, troops and Hero level themselves.' },
    ...
    nuances: [
      ...
      { title: 'Personal quota by Hero level', desc: 'A quota can use "Personal target by Hero level" (meant for EM): a stronger Hero gets a higher target, a weaker one — lower. The quota target is the norm for a typical player with Hero level H₀; k is how many % the target changes per 100 Hero levels. Without a Hero level a player gets the base target marked "?". The formula is temporary and will be refined from season statistics.' },
