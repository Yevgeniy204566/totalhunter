export const DASHBOARD = {
  ...
  chestFinder: {
    title:     'Таблицы сундуков кланов',
    sub:       'Сохраните королевство и клан — ссылка на публичную таблицу сундуков останется в списке.',
    kingdom:   'Королевство',
    clan:      'Клан',
    newItem:   '— новый клан —',
    save:      'Сохранить',
    remove:    'Удалить',
    notFound:  'Клан не найден. Проверьте номер королевства и название клана.',
    empty:     'Введите номер королевства и название клана.',
    saved:     'Сохранено',
  },
  devices: {
    title:       'Устройства',
  ...
  chests: {
    ...
    inPatternTooltip: 'Сундук учитывается в общем шаблоне сборки клана (используется в сводке и на публичной странице).',
    totalEverCol: 'Итого',
    ...
    quotaTooltip: 'Этот сундук засчитывается в прогресс квоты сезона (цель по числу сундуков).',
    accountingCol: 'Учёт',
    rosterTitle: 'Сундуки клана',
    accLegendTitle: 'Что означает «Учёт»',
    accLegendOff: 'Сундук не показывается в таблице клана и очков не даёт. Данные не теряются — можно включить позже.',
    accLegendOn: 'Сундук даёт очки по вашей цене и идёт в общий счёт игрока.',
    accLegendQuotaName: 'Квота (название)',
    accLegendQuotaShort: 'Квота',
    quotaDelete: 'Удалить квоту',
    accLegendQuota: 'Даёт очки и дополнительно считается в столбце своей квоты (цвет зеленее у квоты 2 и 3). Квоты задаются в «Настройках сезона».',
    ...
    quotaTarget: 'Цель',
    addQuota: '+ Квота',
    perPlayer: 'Личная цель по уровню Героя',
    perPlayerHint: 'Цель = база × (1 + k/100 × (Герой − H₀)/100). Формула временная — уточним по статистике.',
    heroK: 'k, % на 100 ур.',
    heroH0: 'H₀, средний Герой',
    quotaNameHint: 'Как назвать столбец',
    quotaTargetHint: 'Сундуков за сезон',
    heroKHelp: 'На сколько % меняется цель за каждые 100 уровней Героя. 0 — у всех одинаково, 20 — Герой на 100 ур. выше H₀ получает цель +20%.',
    heroH0Help: 'Уровень Героя типичного активного игрока. У него цель ровно равна «Цели» квоты; выше — цель больше, ниже — меньше.',
    statsBtn: '⬇ Скачать статистику (CSV)',
  ...
  balance: {
    ...
    sectionSub:    'Оплата банковской картой или криптовалютой · Зачисление мгновенно',
    secureNote:    '🔒 Безопасная оплата · Картой или криптовалютой · Алмазы не сгорают',
