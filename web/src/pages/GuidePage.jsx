...
const FAQ = [
  { q: 'Можно ли пользоваться компьютером, пока работает бот?',
    a: 'Так как бот управляет курсором мыши и клавиатурой, рекомендуем запускать его в то время, когда вы не пользуетесь ПК, либо использовать для этого отдельный ноутбук.' },
  ...
  { q: 'Что такое HWID и зачем он нужен?',
    a: 'Hardware ID — уникальный «отпечаток» вашего компьютера. Лицензия и бесплатный триал привязываются к вашему железу, чтобы исключить злоупотребления и обеспечить честное использование.' },
  { q: 'Кредиты тратятся при ошибке бота?',
    a: 'Нет. Кредиты списываются только за успешный результат (нахождение Биржи или отправку Картера в Склеп). Если бот не нашёл объект или произошёл сбой — ваш баланс останется прежним.' },
            ...
            <Card style={{ marginBottom: 16 }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 14 }}>
                {[
                  ...
                  { icon: '💀', color: '#B060FF', name: 'Склеп (Crypt)', desc: 'Обычные, Редкие или Эпические — бот находит нужный тип в меню и автоматически отправляет вашего Картера на сбор.' },
          ...
          <Section id="calibration" icon="🎯" title="Калибровка">
            <Card style={{ marginBottom: 16 }}>
              <p style={{ fontSize: 14, color: 'var(--on-surface2)', lineHeight: 1.8, marginBottom: 20 }}>
                Калибровка нужна один раз — бот адаптируется под ваш монитор и режим игры.
                Займёт <strong style={{ color: '#FFFFFF' }}>менее минуты</strong>.
              </p>
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 14, marginBottom: 20 }}>
                {[
                  { label: 'Точка A', desc: 'Центр мини-карты — сначала уменьшите зум мини-карты до минимума, затем кликните точно по её центру', color: 'var(--accent)' },
                  { label: 'Точка B', desc: 'Иконка Серебра в интерфейсе — наведите курсор пока не появится символ «+», затем кликните по нему', color: '#B060FF' },
              ...
              <Step n="1" title="Открой игру" desc="Запусти Total Battle именно так, как привык играть — браузер, полный экран или официальный клиент." />
              <Step n="2" title="Вкладка КАЛИБРОВКА" desc="В боте перейди на вкладку КАЛИБРОВКА." />
              <Step n="3" title="Установи точку A" desc='Уменьши зум мини-карты до минимума. Нажми "Установить точку A" → кликни по центру прямоугольника мини-карты.' />
              <Step n="4" title="Установи точку B" desc='Найди иконку Серебра в интерфейсе, наведи курсор до появления «+». Нажми "Установить точку B" → кликни по символу «+».' />
              <Step n="5" title="Сохрани профиль" desc='Выбери нужный слот (1 — клиент игры, 2/3 — браузер) и нажми "Сохранить профиль". Бот запомнит настройки.' />
            </Card>
          </Section>
              ...
              {[
                {
                  ...
                  params: ['Дальность: 100% — для полного охвата королевства', 'Скорость: рекомендуется максимум'],
                  tip: 'При обнаружении Биржи бот подаёт звуковой сигнал и останавливается — вы выкупаете войска вручную.',
                },
                {
                  icon: '💀', color: '#B060FF', name: 'Склепы',
                  cost: '1 кредит / находка',
                  params: ['Дальность марша: время хода Картера до самого дальнего склепа (в минутах)', 'Ускорение 0–5: каждый уровень сокращает время пути вдвое'],
                  tip: 'Требуется не менее 70 000 единиц масла на аккаунте — иначе бот автоматически остановит сбор.',
                },
