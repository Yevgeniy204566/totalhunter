  ...
  return (
    <div style={{ background: 'var(--bg)', minHeight: '100vh', fontFamily: 'Inter, sans-serif' }}>
      ...
      <section style={{
        ...
        <div style={{ position: 'relative', maxWidth: 800 }}>
          ...
          <h1 style={{
            ...
            <span style={{
              color: 'var(--accent)',
              textShadow: '0 0 48px rgba(61,127,255,0.55)',
            }}>
              {LANDING.heroAccent}
            </span>
          </h1>
      ...
      <section id="features" style={{ padding: '88px 24px', background: 'var(--card)' }}>
        <div style={{ maxWidth: 920, margin: '0 auto' }}>
          ...
          <div style={{
            ...
            {LANDING.features.map(({ icon, color, title, desc }) => (
      ...
      <section style={{
        ...
        background: `
          radial-gradient(ellipse 60% 80% at 50% 50%, rgba(61,127,255,0.10) 0%, transparent 70%),
          var(--bg)
        `,
        borderTop: '1px solid var(--outline)',
      }}>
