...
> Последнее обновление: 2026-07-01, 19:47 (Kyiv) — Хангоф #115: Древний — новая формула войск, звание+квота в ростере, недобор квоты (пункт Д закрыт); публичка — № колонка + полировка точек (все задеплоены)
